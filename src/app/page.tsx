    ...
    screens: [
      {
        ...
        notes: [
          '요약 카드 — 【이번달 발송 완료】 당월 캠페인 수·전월 대비 증감 / 【발송 예정】 현재 발송 예정 건 수 / 【이번달 총 수신 인원】 당월 수신자 합산 /【잔여 포인트】 실시간 잔여 포인트·1건당 비용 체크 필요',
          '검색·필터: 기간·메시지 종류 필터 및 캠페인명 검색',
          '발송 완료 탭: 오픈율·클릭 수·발송 성공률 등 성과 지표',
          '발송 예정 탭: 예약된 캠페인 목록 및 발송 취소 기능',
          '새 메시지 만들기: 신규 캠페인 등록 화면으로 이동',
          '충전하기: 클릭 시 호출되는 팝업은 발주모아에 이미 존재',
        ],
      },
      {
        id: 'bm-empty',
      ...
      },
      {
        ...
        notes: [
          ...
          '발송 설정: 즉시 발송 또는 예약 발송 일시 선택',
          '우측 미리보기: 실시간 메시지 렌더링 확인',
          '브랜드 메시지 수신차단 시 LMS 자동 발송: 수신차단 파트너에게 LMS로 자동 발송 / 내용 글자수와 무관하게 LMS 단가 적용(SMS 단가 적용하지 않음)',
        ],
      },
      {
        ...
        notes: [
          '상단 인라인 경고: 카카오톡 채널 미등록 안내 + 기본설정 링크',
          'LMS 자동 발송 섹션 비활성화: 무료 수신거부번호 미등록 안내 + 기본설정 링크',
          '나머지 폼 항목은 정상 입력 가능',
        ],
      },
      {
        ...
        notes: [
          ...
          '상세 수치: 발송 수·발송 성공 수·발송 실패 수·메시지 오픈 수·오픈율(%)·버튼 클릭 수·버튼 클릭률(%)·메시지 클릭 파트너 수(유니크)·상품 상세 페이지 방문 수·상품 상세 방문 파트너 수·이미지 내려받기 클릭 수·차감 포인트',
  ...
  },
  {
    ...
    screens: [
      ...
      },
      {
        ...
        notes: [
          '발신번호 관리: 등록된 번호·승인 상태 확인, 신청 내역 포함 (참조: 플렉스지 /Sms/sms_set_happyTalk)',
          '카카오톡 채널 "등록 완료" 배지로 연동 상태 표시',
          '변경을 클릭한 경우 카카오톡 채널 등록(재 등록)하여야 함.',
        ],
      },
    ],
  },
    ...
    screens: [
      {
        ...
        notes: [
          '요약 카드: 잔여 포인트·이번 달 충전·이번 달 사용',
          '포인트 충전: 금액 선택 또는 직접 입력, 결제 수단(신용카드·계좌이체·가상계좌)',
          '충전/사용 내역 탭으로 구분 조회',
        ],
      },
    ],
