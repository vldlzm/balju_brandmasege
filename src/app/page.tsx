    ...
    screens: [
      {
        ...
        notes: [
          '【이번달 발송 완료】 당월 1일~말일 기준 발송 완료된 캠페인 수. 전월 동기간 대비 증감 표시 (양수 초록 / 음수 빨강 / 동일 미표시)',
          '【발송 예정】 당월 1일~말일 기준 예약 상태인 캠페인 수. 전월 동기간 대비 증감 표시',
          '【이번달 총 수신 인원】 당월 발송 완료 캠페인의 수신자 수 합산. 전월 동기간 대비 증감 표시',
          '【잔여 포인트】 누적 충전액 - 누적 사용액. 전월 말일 잔액 대비 증감 표시',
