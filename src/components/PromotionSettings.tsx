        ...
        <section className="relative overflow-visible rounded-2xl bg-white shadow-sm ring-1 ring-gray-100">
          ...
          <div className="px-6 py-5">
            ...
            <div className="mt-4 flex justify-center gap-2">
              <button className="rounded-xl border border-gray-200 px-6 py-2.5 text-sm font-semibold text-gray-600 hover:bg-gray-50 transition-colors">
                초기화
              </button>
              <button className="rounded-xl bg-[#4DB87A] px-6 py-2.5 text-sm font-semibold text-white hover:bg-[#3da869] transition-colors">
                적용
              </button>
            </div>
          </div>
