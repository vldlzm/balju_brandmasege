...
const INITIAL_SENDERS: SenderNumber[] = [
  { id: 's1', name: '발주모아 파트너스', number: '000-000-0000', enabled: true,  isRepresentative: true  },
  { id: 's2', name: '발주모아 고객센터', number: '000-000-0000', enabled: true,  isRepresentative: false },
  { id: 's3', name: '발주모아 마케팅팀', number: '000-000-0000', enabled: false, isRepresentative: false },
];

const REQUESTS: SenderRequest[] = [
  { id: 'r1', number: '000-000-0000', status: '승인', requestedAt: '2025.03.10', processedAt: '2025.03.11', memo: '' },
  { id: 'r2', number: '000-000-0000', status: '승인', requestedAt: '2025.03.18', processedAt: '2025.03.19', memo: '' },
  { id: 'r3', number: '000-000-0000', status: '승인', requestedAt: '2025.04.02', processedAt: '2025.04.03', memo: '' },
];
...
export default function PromotionSettingsComplete() {
  const [senders, setSenders] = useState<SenderNumber[]>(INITIAL_SENDERS);
  const [savedSenders, setSavedSenders] = useState<SenderNumber[]>(INITIAL_SENDERS);
            ...
            <div>
              ...
              {senders.length === 0 ? (
                <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-gray-200 py-10 text-center">
                  ...
                  <p className="mt-1 text-xs text-gray-400">발신번호를 신청하면 승인 후 LMS 발송에 사용할 수 있습니다</p>
                </div>
              ) : (
          ...
          <div className="divide-y divide-gray-100 px-6">
            ...
            <div className="py-5">
              <div className="flex items-start gap-6">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  {rejectType === '신규' && (
                    <button className="w-fit rounded-xl bg-[#4DB87A] px-5 py-2 text-sm font-semibold text-white hover:bg-[#3da869] transition-colors">
                      신청
                    </button>
                  )}
                  {rejectType === '직접입력' && (
            ...
            <div className="py-5">
              <div className="flex items-start gap-6">
                ...
                <div className="flex items-center gap-3">
                  <div className="relative overflow-visible flex items-center gap-2 rounded-xl border border-[#4DB87A]/30 bg-[#f0faf5] px-4 py-2.5">
                    <Bubble n={2} />
          ...
          <div className="divide-y divide-gray-100 px-6">
            <div className="flex items-center gap-6 py-5">
              ...
              <button
                ...
                className="flex items-center gap-1 rounded-xl border border-gray-300 bg-gray-50 px-3.5 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-100 transition-colors"
              >
                파트너 제외 선택
