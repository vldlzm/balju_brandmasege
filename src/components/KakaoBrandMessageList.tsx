...
const SCHEDULED: ScheduledMessage[] = [
  ...
  },
  {
    ...
    title: '5월 황금연휴 특별 기획전 참여 파트너 모집',
    targetCount: 96,
    targetLabel: '뷰티·패션 파트너 96명',
    formatType: '와이드 리스트',
    points: 1440,
  },
  {
...
const FORMAT_ICON: Record<FormatType, React.ReactNode> = {
  '와이드 이미지': '🖼',
  '와이드 리스트': '📋',
  '캐러셀 피드': <CarouselSVG />,
};
